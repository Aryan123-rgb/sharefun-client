...
import { renderInitialState } from "../redux/slice/authSlice";

const ForgotPassword = () => {
  const { resetPasswordStatus: step } = useSelector(
    ...
    <div className="bg-bgColor w-full h-screen flex items-center justify-center p-6">
      <div className="w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex bg-primary rounded-xl overflow-hidden shadow-xl">
        ...
        <div className="w-full lg:w-1/2 h-full p-10 2xl:px-20 flex flex-col justify-center ">
          ...
          <p className="text-ascent-1 text-base mb-4 font-semibold">
